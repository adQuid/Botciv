...
public class ResourceDescriptionWrapper extends DescriptionWrapper{
	...
	public static ResourceDescriptionWrapper wealth = new ResourceDescriptionWrapper("Influence is a measure of the stregth of your leadership and beurocracy. A power structure with more influcence can convince more people to act with the same will, and sees tasks done more efficiently. One with little to no influence will find any order ignored, and risks collapse. No single government can store more than 1000 influence.");
	public static ResourceDescriptionWrapper influence = new ResourceDescriptionWrapper("Money, jewels, toasters, anything you wouldn't eat or build a house with is wealth. Wealth won't directly help you do much, but it can often be traded for things that can. Advanced societies tend to need to pay for more things as people have higher standards of what the world owes them.");
